...
def install():
    ...
    from src.cli.completion import detect_shell, install_completion, get_completion_install_path
...
def uninstall():
    ...
    from src.cli.completion import detect_shell, uninstall_completion
