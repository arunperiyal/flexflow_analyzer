"""
Field command group - Work with Tecplot PLT files
Subcommands: info, extract
"""
...
class FieldCommand(BaseCommand):
    ...
    def show_help(self):
        ...
        table.add_row("extract", "Extract data to CSV (was: tecplot extract)")

        console.print("[bold]SUBCOMMANDS:[/bold]")
        console.print(table)
        console.print()
        console.print("[bold]EXAMPLES:[/bold]")
        console.print("    flexflow field info myCase --basic")
        console.print("    flexflow field extract myCase --variables pressure,velocity")
        console.print()
