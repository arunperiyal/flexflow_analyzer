"""
Field info command implementation
"""
...
def execute_info(args):
    ...
    print()
    print(f"  Extract field data to CSV:")
    print(f"    {Colors.YELLOW}flexflow field extract {case_dir.name} --timestep {first_step} --variables Y --zone FIELD{Colors.RESET}")
    print()
