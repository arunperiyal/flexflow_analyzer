...
class ConfigCommand(BaseCommand):
    ...
    def setup_parser(self, subparsers):
        ...
        template_parser.add_argument('template_type', nargs='?',
                                    help='Template type: single, multi, fft, or case')
        template_parser.add_argument('output', nargs='?', type=str,
                                    help='Output file path (optional, uses defaults if not specified)')
    ...
    def execute(self, args):
        ...
        if hasattr(args, 'config_subcommand') and args.config_subcommand == 'template':
            # Delegate to template subcommand
    ...
    def show_help(self):
        ...
        console.print("    flexflow config template single my_plot.yaml")
        console.print("    flexflow config template multi comparison.yaml")
        console.print("    flexflow config template case batch_cases.yaml")
        console.print()
