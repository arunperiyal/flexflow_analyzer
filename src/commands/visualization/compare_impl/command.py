...
def execute_separate_plots(args, logger, plot_styles, legend_labels, default_colors):
    ...
    for i, case_dir in enumerate(args.cases):
        ...
        # Set labels
        from src.commands.plot_impl.command import parse_label
...
def execute_compare(args):
    ...
    try:
        ...
        # Parse plot styles
        from src.commands.plot_impl.command import parse_multiple_plot_styles
        ...
        for idx, current_ax in enumerate(axes[:len(args.cases)]):
            ...
            if not use_subplots:
                ...
                from src.commands.plot_impl.command import parse_legend_style
