...
class TecplotCommand(BaseCommand):
    ...
    def execute(self, args):
        ...
        if hasattr(args, 'tecplot_subcommand') and args.tecplot_subcommand:
            from .tecplot_impl import command as tecplot_cmd
    ...
    def show_help(self):
        """Show help message"""
        from .tecplot_impl.help_messages import print_tecplot_help
        print_tecplot_help()
    
    def show_examples(self):
        """Show usage examples"""
        from .tecplot_impl.help_messages import print_tecplot_examples
