"""
Data command group - Domain-driven structure
Handles data operations: show, stats
"""
...
class DataCommand(BaseCommand):
    ...
    def execute(self, args):
        ...
        if hasattr(args, 'data_subcommand') and args.data_subcommand == 'show':
            ...
            from flexflow.commandspreview_cmd import command as preview_cmd
            preview_cmd.execute_preview(args)
        elif hasattr(args, 'data_subcommand') and args.data_subcommand == 'stats':
            # Delegate to statistics command
            from flexflow.commandsstatistics_cmd import command as statistics_cmd
