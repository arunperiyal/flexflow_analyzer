"""
Template command - migrated to new command pattern
"""
...
class TemplateCommand(BaseCommand):
    ...
    name = "template"
    description = "Generate template YAML files"
    category = "Utilities"
    ...
    def execute(self, args):
        ...
        if hasattr(args, 'help') and args.help:
            ...
            from ..template_cmd import command as template_cmd
            template_cmd.execute_template(args)
    
    def show_help(self):
        """Show help message"""
        from ..template_cmd.help_messages import print_template_help
        print_template_help()
    
    def show_examples(self):
        """Show usage examples"""
        from ..template_cmd.help_messages import print_template_examples
