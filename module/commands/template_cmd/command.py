...
def execute_template(args):
    ...
    """
    from .help_messages import print_template_help
    ...
    try:
        ...
        if template_type == 'single':
            ...
            print(f"Valid types: single, multi, fft", file=sys.stderr)
            sys.exit(1)
        ...
        print(f"then run: {Colors.cyan(f'flexflow plot --input-file {output_file}')}")
