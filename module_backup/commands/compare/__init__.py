...
class CompareCommand(BaseCommand):
    ...
    def execute(self, args):
        ...
        if hasattr(args, 'help') and args.help:
            ...
            from ..compare_cmd import command as compare_cmd
            compare_cmd.execute_compare(args)
    
    def show_help(self):
        """Show help message"""
        from ..compare_cmd.help_messages import print_compare_help
        print_compare_help()
    
    def show_examples(self):
        """Show usage examples"""
        from ..compare_cmd.help_messages import print_compare_examples
