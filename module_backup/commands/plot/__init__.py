"""
Plot command - migrated to new command pattern
"""
...
class PlotCommand(BaseCommand):
    ...
    def execute(self, args):
        ...
        if hasattr(args, 'help') and args.help:
            ...
            from ..plot_cmd import command as plot_cmd
            plot_cmd.execute_plot(args)
    
    def show_help(self):
        """Show help message"""
        from ..plot_cmd.help_messages import print_plot_help
        print_plot_help()
    
    def show_examples(self):
        """Show usage examples"""
        from ..plot_cmd.help_messages import print_plot_examples
        print_plot_examples()
