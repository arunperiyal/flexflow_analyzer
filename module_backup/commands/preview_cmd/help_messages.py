...
def print_preview_help():
    ...
    print(f"""
{Colors.BOLD}{Colors.CYAN}FlexFlow Preview Command{Colors.RESET}

Preview displacement data from OTHD files in tabular format.

{Colors.BOLD}USAGE:{Colors.RESET}
    flexflow preview {Colors.YELLOW}<case_directory>{Colors.RESET} [options]
...
{Colors.BOLD}Preview first 10 timesteps for node 0 (default):{Colors.RESET}
    flexflow preview CS4SG1U1

{Colors.BOLD}Preview specific node:{Colors.RESET}
    flexflow preview CS4SG1U1 --node 24
    flexflow preview CS4SG1U1 --node 10

{Colors.BOLD}Preview specific time range:{Colors.RESET}
    flexflow preview CS4SG1U1 --start-time 50.0 --end-time 100.0
    flexflow preview CS4SG1U1 --node 24 --start-time 100.0 --end-time 150.0

{Colors.BOLD}Preview with verbose output:{Colors.RESET}
    flexflow preview CS4SG1U1 --node 10 --verbose
""")
